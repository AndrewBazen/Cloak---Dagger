    ...
    public class StatController
    {
        ...
        private void UpdateModifiers(CharacterInfoData player)
        {
            for (var i = 0; i < player.Stats.Count; i++)
            {
                ...
                {
                    case 6 or 7:
                        player.Modifiers[i] = -2;
                        break;
                    case 8 or 9:
                        player.Modifiers[i] = -1;
                        break;
                    case 10 or 11:
                    ...
                    case 14 or 15:
                        ...
                        break;
                    case 16 or 17:
                        player.Modifiers[i] = 3;
                        break;
                    case 18 or 19:
                        player.Modifiers[i] = 4;
                        break;
                    case 20 or 21:
                        player.Modifiers[i] = 5;
                        break;
                    case 22 or 23:
                        player.Modifiers[i] = 6;
                        break;
                    case 24 or 25:
                        player.Modifiers[i] = 7;
                        break;
                    case 26 or 27:
                        player.Modifiers[i] = 8;
                        break;
                    case 28 or 29:
                        player.Modifiers[i] = 9;
                        break;
                    case 30:
                        player.Modifiers[i] = 10;
                        break;
                    case < 6:
                        player.Modifiers[i] = -3;
                        break;
